 ...
 */
public final class EMPC_LC_NoRplTime30 extends EMPC_LC_NoRplTime01 {

   private static final AbstractCachingPolicy singelton = new EMPC_LC_NoRplTime30();
   ...
   protected boolean checkAbortRplc(PCDemand.RegistrationInfo dmdRegInfo, SmallCell sc) {
      return checkAbortRplc(dmdRegInfo, sc, 30/* minimum time to handoff 
