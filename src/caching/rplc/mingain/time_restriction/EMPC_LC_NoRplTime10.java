 ...
 */
public final class EMPC_LC_NoRplTime10 extends EMPC_LC_NoRplTime01 {

   private static final AbstractCachingPolicy singelton = new EMPC_LC_NoRplTime10();
  ...
  @Override
   protected boolean checkAbortRplc(PCDemand.RegistrationInfo dmdRegInfo, SmallCell sc) {
      return checkAbortRplc(dmdRegInfo, sc, 10/* minimum time to handoff 
