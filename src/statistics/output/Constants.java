...
public class Constants {
   ...
   //</editor-fold>
   //</editor-fold>
   public final static String DEFAULT_STATS_PATH //@todo temporary solution: DEFAULT_STATS_PATH hard coded  
           = System.getProperty("user.home") + "/Dropbox/2014-2015-EPC+POP/trunk/files/results";
}
